...
from lab.training_tools import ClassicTrainingTools
...
def train_eval(model_name: str, train_loader: DataLoader, tests_params: pd.DataFrame, sample_period: int,
    ...
    # Load the best model that was found during training
    # best_model = callbacks[0].best_model_path
    # model = ClassicTrainingTools.load_from_checkpoint(best_model)
